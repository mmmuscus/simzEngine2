...
void vkPipelineWrapper::initGraphicsPipeline() {
	...
	// This struct decribes what kind of topology will be drawn (line/triangle/triangle strip etc)
	...
	// This struct describes the rasterizer, what it culls, how it draws geometry etc...
	...
	// This struct configures multisampling
	...
	// This structure referemces the array of structures for all of the framebuffers
	...
	// The structure that creates the VkPipelineLayout
...
VkShaderModule vkPipelineWrapper::createShaderModule(const std::vector<char>& code) {
